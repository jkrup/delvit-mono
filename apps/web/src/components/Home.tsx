					...
					<div className='bg-neutral-100 rounded-md p-4 flex space-x-2 items-center'>
						...
						{selectedType === 'posts' ? (
							<Link href='/articles/new' legacyBehavior>
								<input className='grow rounded-md px-2 h-8' type='text' placeholder='Create Post' />
							</Link>
						) : (
							<Link href='/questions/new' legacyBehavior>
								<input className='grow rounded-md px-2 h-8' type='text' placeholder='Create Question' />
							</Link>
						)}
