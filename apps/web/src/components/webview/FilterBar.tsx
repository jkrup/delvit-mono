    ...
    <div className="flex justify-between">
      <div className="flex space-x-4">
        <button
          className={
            "flex items-center " +
            (mode === "NEW" ? "font-bold text-stone-800" : "text-stone-500")
          }
          onClick={() => {
        ...
        <button
          className={
            "flex items-center" +
            (mode === "TOP" ? " font-bold text-stone-800 " : " text-stone-500")
          }
          onClick={() => {
        ...
        <button
          disabled
          className="flex items-center text-stone-200 disabled:cursor-not-allowed"
        >
