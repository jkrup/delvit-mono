...
const ArticlesFeed = () => {
	...
	const articlesData = trpc.useQuery(['article.getAllArticles', { mode, topic }])
		...
		<div className='col-span-2 flex flex-col space-y-4'>
			<div className='bg-white rounded-md p-2 px-4 flex space-x-2 items-center'>
				...
				<Link href='/articles/new' legacyBehavior>
					<input className='grow rounded-md bg-zinc-200 px-2 h-8' type='text' placeholder='Create Post' />
				</Link>
			...
			<div className='bg-white rounded-md p-2 px-4'>
				<div className='flex justify-between'>
					<div className='flex space-x-2'>
						...
						<button disabled={true} className='flex items-center disabled:text-gray-400'>
