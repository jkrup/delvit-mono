              ...
              return (
                <FeedConsensusQuestion
                  ...
                  author={{
                    ...
                    name:
                      pendingQuestion.author.name ?? pendingQuestion.author.id,
                  }}
        ...
        <>
          <div className="flex flex-col space-y-6">
                ...
                <div key={pendingQuestion.id}>
                  <FeedConsensusQuestion
                    ...
                    author={{
                      id: pendingQuestion.author.id,
                      name:
                        pendingQuestion.author.name ??
                        pendingQuestion.author.id,
                    }}
                    answer={pendingQuestion.answer}
                    title={pendingQuestion.title}
                  />
            ...
            <FeedConsensusQuestion
              ...
              answer={{
                result: "Yes",
                body: "The consensus is that Roborock does have the better mop for the following reasons: 1. It lifts the mop when approaching carpet so that it does not get wet. This saves time as you do not need to remove the mop attachment...",
              }}
              title={
                "Does Roborock S7 MaxV Ultra Robot Vacuum actually have a better MOP than Evocacs DEEBOT X1 OMNI?"
              }
            />
          </div>
        </>
    ...
    <div className="flex flex-col space-y-2 grow">
      <div className="flex space-x-8 text-gold items-center">
        <div className="flex space-x-2 items-center w-1/2">
          ...
          <div className="text-sm bg-gold rounded-lg animate-pulse w-full">
            {"x"}
          </div>
        </div>
      </div>
