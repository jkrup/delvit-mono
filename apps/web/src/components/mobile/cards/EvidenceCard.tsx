...
const EvidenceCard = (props: EvidenceProps) => {
	const { author, createdAt, title, body, evidenceBlocksCount, articleUrl, url, evidenceType, avatar } = props
	...
	return (
		<div className='rounded bg-white  p-3 m-2'>
			<CardHeader author={{ name: author, avatarUrl: avatar, id: '' }} createdAt={createdAt} evidence={evidenceType} />
