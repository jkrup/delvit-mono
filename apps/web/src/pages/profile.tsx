			...
			<div className='bg-gray-50 min-h-screen'>
				...
				<div className='flex my-8 mx-auto space-x-16 justify-around max-w-screen-xl'>
					<div className='rounded flex flex-col basis-2/5 shadow-yellow-800 shadow-lg justify-center p-4 px-8 items-center h-fit'>
						...
						<h2 className='text-2xl font-semibold text-yellow-800 font-serif'>{name}</h2>
					...
					<form className='px-8 pt-6 pb-8 mb-4 flex flex-col space-y-4 basis-1/2 h-fit' onSubmit={onSubmit}>
						<h1 className='text-yellow-800 text-xl font-serif font-semibold'>Edit your profile</h1>
						<input
							id='upload-profile'
							type='file'
							className='hidden'
						...
						<div>
							<label className='block text-yellow-800 text-sm mb-2' htmlFor='username'>
								Name
							</label>
							<input
						...
						<div>
							<label className='block text-yellow-800 text-sm mb-2' htmlFor='title'>
								Title
							</label>
							<input
								className='rounded w-full py-2 px-3 bg-stone-100 focus:shadow-outline'
						...
						<div>
							<label className='block text-yellow-800 text-sm mb-2' htmlFor='bio'>
								About Me
							</label>
							<textarea
								className='rounded w-full py-2 px-3 bg-stone-100 focus:shadow-outline'
				...
				<div className='flex flex-col my-8 mx-auto max-w-screen-xl'>
					{points.map((point) => (
						<div className='rounded bg-yellow-600 bg-opacity-5 flex flex-row my-4 shadow-md justify-center items-center p-4'>
							<div className='mr-4'>{point.kind}</div>
							<div className='mr-4'>
								{point.amount > 0 ? (
