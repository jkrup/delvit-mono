        ...
        <div className="min-h-screen">
          <div className="bg-white mx-auto my-8 rounded-md p-10 max-w-screen-xl">
            <div className="text-center">
              <h1 className="text-2xl font-bold font-serif text-yellow-800">
                About the Schelling Point System
              </h1>
              <hr className="text-black mx-auto mt-2 mb-8" />
              <p className="text-left my-4">
                Lorem ipsum dolor sit amet, and more stuff like that. Blah blah
                blah.. all the text we need. Lorem ipsum dolor sit amet, and
                more stuff like that. Blah blah blah.. all the text we need.
                Lorem ipsum dolor sit amet, and more stuff like that. Blah blah
                blah.. all the text we need. Lorem ipsum dolor sit amet, and
                more stuff like that. Blah blah blah.. all the text we need.
                Lorem ipsum dolor sit amet, and more stuff like that. Blah blah
