					...
					<div className='p-2 flex flex-col col-span-3 space-y-2'>
						...
						<div className='flex flex-col shadow px-8 py-4 rounded-lg space-y-4'>
							...
							<div>
								<span
									className={`rounded-lg px-12 py-2 font-serif font-semibold ${
										questionData.Consensus?.answer === 'FOR' ? 'bg-green-200 text-green-600' : 'bg-red-200 text-red-800'
									}`}
								>
							...
							<div className='whitespace-pre-line'>
								...
								>
									{questionData.Consensus?.answer === 'FOR' ? 'YES' : 'NO'} ({questionData.Consensus?.confidence} level
									of confidence)
								</span>
